...
#define NUM_LOCAL_NOMES 10
#define SIZE_LOCAL_NOMES 5

#define NUM_PROFESSORES 20
...
#define NUM_CURSOS 20
#define SIZE_CURSOS_EXATAS 3
#define SIZE_CURSOS_HUMANAS 3
#define SIZE_CURSOS_MEDICAS 3

#define NUM_DISCIPLINAS 20
#define SIZE_DISCIPLINAS_CODIGOS 20
#define SIZE_DISCIPLINAS_EMENTA 3
#define SIZE_DISCIPLINAS_BIBLIOGRAFIA 3

#define SIZE_DISCIPLINAS_OBRIGATORIAS_EXATAS 1
#define SIZE_DISCIPLINAS_OPTATIVAS_EXATAS 1
#define SIZE_DISCIPLINAS_ELETIVAS_EXATAS 1

#define SIZE_DISCIPLINAS_OBRIGATORIAS_HUMANAS 1
#define SIZE_DISCIPLINAS_OPTATIVAS_HUMANAS 1
#define SIZE_DISCIPLINAS_ELETIVAS_HUMANAS 1

#define SIZE_DISCIPLINAS_OBRIGATORIAS_MEDICAS 1
#define SIZE_DISCIPLINAS_OPTATIVAS_MEDICAS 1
#define SIZE_DISCIPLINAS_ELETIVAS_MEDICAS 1

#define NUM_REL_PRE_REQUISITOS 5

#define NUM_REL_CURSO_DISCIPLINA 5

#define NUM_TURMAS 3

#define NUM_REL_TURMA_ALUNOS 140

#define NUM_EXTENSAO 10
#define SIZE_EXTENSAO 4

#define NUM_TRABALHO 20
...
int main()
{
    ...
    vector <Disciplina> disciplinas = disciplinas_obrigatorias;
