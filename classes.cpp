...
Pessoa::Pessoa (int cd_Pessoa, string nm_Pessoa, string nm_Sexo, int nu_Idade): cd_Pessoa (cd_Pessoa), nm_Pessoa(nm_Pessoa), nm_Sexo(nm_Sexo)
				, nu_Idade(nu_Idade) {}
...
Disciplina::Disciplina (int cd_Disciplina, string cd_Codigo, int hh_Carga_Horaria, string nm_Ementa, string nm_Bibliografia
                        , string nm_Disciplina, int nu_Creditos): cd_Disciplina(cd_Disciplina), cd_Codigo(cd_Codigo)
                                                , hh_Carga_Horaria(hh_Carga_Horaria), nm_Ementa(nm_Ementa)
                                                , nm_Bibliografia(nm_Bibliografia), nm_Disciplina(nm_Disciplina), nu_Creditos(nu_Creditos) {}



Rel_Curso_Disciplina::Rel_Curso_Disciplina (Curso cd_Curso, Disciplina cd_Disciplina, string nm_Obrigatoriedade, int nu_Periodo) :
                                            cd_Curso(cd_Curso), cd_Disciplina(cd_Disciplina), nm_Obrigatoriedade(nm_Obrigatoriedade)
											, nu_Periodo(nu_Periodo){}
...
Turma::Turma (int cd_Turma, Disciplina cd_Disciplina, Local cd_Local, Professor cd_Professor, int hh_Horario, int nu_Vagas
              , int nu_Turma, int nu_Ano, int nu_Semestre): cd_Turma(cd_Turma), cd_Disciplina(cd_Disciplina), cd_Local(cd_Local), cd_Professor(cd_Professor)
              , hh_Horario(hh_Horario), nu_Vagas(nu_Vagas), nu_Turma(nu_Turma), nu_Ano(nu_Ano), nu_Semestre(nu_Semestre) {}
